...
declare module 'facile/core' {
    ...
    import { Lifecycle } from 'facile/core/lifecycle';
    import { IFacile, IConfig, IRouters, IRoute, IBoom, ICallback, IFilter, IMiddlewares, ISockets, IModels, IControllers, IModel, IController, IUtils, IFilters, IConfigs, IRequestHandler, IRoutesMap, IService, IServices, IInit } from 'facile/interfaces';
    /**
        * Facile Core
        *
        * @export
...
declare module 'facile/core/lifecycle' {
    import { ILifecycle } from 'facile/interfaces';
    import { EventEmitter } from 'events';
